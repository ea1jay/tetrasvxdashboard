...
?>
      <tr>
        ...
        <td><div class="progress"><div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<?php echo trim($percent, '%') ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo trim($percent, '%') ?>%; color: black;"><?php echo trim($percent, '%') ?>%</div></div></td>
